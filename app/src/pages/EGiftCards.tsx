  ...
  return (
    <div ref={pageRef} style={{ backgroundColor: '#ffffff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-6 pb-2">
        <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: '#8a8a8a' }}>
      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="egift-reveal lg:w-1/2">
            {/* Title */}
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(28px, 3vw, 36px)', color: '#1a1a1a', fontWeight: 400, marginBottom: '12px' }}>
              {t.title}
            </h1>
            ...
            {/* Features */}
            <h3 style={{ fontFamily: "'Inter', sans-serif", fontSize: '18px', color: '#1a1a1a', fontWeight: 500, marginBottom: '12px' }}>
              {t.features}
            </h3>
            ...
            <div
              ...
              style={{ borderRadius: '12px', backgroundColor: '#faf6f4' }}
            >
              <img
            ...
            <div className="mb-5 relative">
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: 500,
                  color: selectedAmount ? '#1a1a1a' : '#8a8a8a',
                  cursor: 'pointer',
                  letterSpacing: '0.05em',
                }}
              >
                <span>{selectedAmount ? `${selectedAmount} ${t.currency}` : t.selectAmount}</span>
                <ChevronDown size={18} color="#8a8a8a" style={{ transform: dropdownOpen ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s' }} />
              </button>
              {dropdownOpen && (
                <div
                  ...
                  {amounts.map((amt) => (
                    <button
                      ...
                      style={{
                        ...
                        color: '#1a1a1a',
                        border: 'none',
                        backgroundColor: selectedAmount === amt ? '#faf6f4' : '#ffffff',
                        cursor: 'pointer',
                        borderBottom: '1px solid #f0e8e8',
                      }}
                      onClick={() => { setSelectedAmount(amt); setDropdownOpen(false); }}
                      onMouseEnter={(e) => { if (selectedAmount !== amt) e.currentTarget.style.backgroundColor = '#faf6f4'; }}
                      onMouseLeave={(e) => { if (selectedAmount !== amt) e.currentTarget.style.backgroundColor = '#ffffff'; }}
                    >
                      {amt} {t.currency}
                    </button>
                  ))}
            ...
            >
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '16px', color: '#1a1a1a', fontWeight: 500 }}>{quantity}</span>
              <button
            ...
            <div className="flex items-center gap-3 mb-6">
              <button
                ...
                style={{
                  width: '20px',
                  height: '20px',
                  border: isGift ? '2px solid #d4a5a5' : '2px solid #e0d0d0',
                  borderRadius: '4px',
                  backgroundColor: isGift ? '#d4a5a5' : '#ffffff',
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                {isGift && <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>}
              </button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <button
          ...
          style={{ fontFamily: "'Inter', sans-serif", color: '#8a8a8a', textDecoration: 'underline', background: 'none', border: 'none', cursor: 'pointer' }}
        >
